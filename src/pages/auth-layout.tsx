...
export function AuthLayout({ title, description, children, footer }: AuthLayoutProps) {
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(102,93,232,0.18),transparent_32%),radial-gradient(circle_at_bottom_right,rgba(56,189,248,0.12),transparent_28%),linear-gradient(180deg,var(--background),color-mix(in_oklch,var(--background),black_4%))] px-4 py-8 text-foreground flex items-center justify-center">
        ...
        <div className="grid w-full gap-8 lg:grid-cols-[1.1fr_0.9fr] items-stretch">
          ...
          <div className="flex flex-col justify-between space-y-8 rounded-4xl border border-border/60 bg-card/95 dark:bg-zinc-950/40 p-8 relative overflow-hidden">
            ...
            <div className="flex items-center gap-2">
              <div className="size-7 rounded-lg bg-linear-to-tr from-primary to-violet-500 flex items-center justify-center shadow-lg shadow-primary/25">
            ...
            <div className="space-y-4">
              <h1 className="max-w-xl text-3xl font-extrabold tracking-tight sm:text-4xl bg-linear-to-r from-foreground via-foreground/90 to-foreground/75 bg-clip-text">
                {title}
              </h1>
